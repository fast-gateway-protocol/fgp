# Doctrine: safari (FGP Safari Daemon)

## Purpose
- Provide fast local safari operations for agent workflows.
...
## Roadmap
- Expand coverage for additional safari workflows.
