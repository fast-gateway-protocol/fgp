# Doctrine: spotlight (FGP Spotlight Daemon)

## Purpose
- Provide fast local spotlight operations for agent workflows.
...
## Roadmap
- Expand coverage for additional spotlight workflows.
