# Doctrine: contacts (FGP Contacts Daemon)

## Purpose
- Provide fast local contacts operations for agent workflows.
...
## Roadmap
- Expand coverage for additional contacts workflows.
