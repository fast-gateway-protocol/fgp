# Doctrine: system (FGP System Daemon)

## Purpose
- Provide fast local system operations for agent workflows.
...
## Roadmap
- Expand coverage for additional system workflows.
