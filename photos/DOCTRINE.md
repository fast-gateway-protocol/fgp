# Doctrine: photos (FGP Photos Daemon)

## Purpose
- Provide fast local photos operations for agent workflows.
...
## Roadmap
- Expand coverage for additional photos workflows.
