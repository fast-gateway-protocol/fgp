//! FGP Keychain Daemon binary.
//!
//! ## Security Notes
//!
//! This binary must be code-signed to access the Keychain:
//! ```bash
//! codesign -s - ./fgp-keychain-daemon
//! ```
//!
//! CHANGELOG:
...
fn main() -> Result<()> {
    ...
    let socket_dir = PathBuf::from(home).join(".fgp/services/keychain");
