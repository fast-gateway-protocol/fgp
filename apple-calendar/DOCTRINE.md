# Doctrine: apple-calendar (FGP Apple Calendar Daemon)

## Purpose
- Provide fast local apple calendar operations for agent workflows.
...
## Roadmap
- Expand coverage for additional apple calendar workflows.
